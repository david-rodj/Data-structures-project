 ...
 *
 * Ejemplo:
 * Comando cmd = stringToComando("cargar"); // cmd será Comando::CARGAR
 */
Comando stringToComando(const string &str)
{
    ...
    if (str == "ruta_corta")
        return Comando::RUTA_CORTA;
    if (str == "ruta_corta_centro")
        return Comando::RUTA_CORTA_CENTRO;
 ...
 *
 * Esta función imprime en consola una lista de todos los comandos disponibles
 * y su descripción.
 *
 * Ejemplo:
 * mostrarAyuda(); // Muestra la lista de comandos disponibles.
 */
void mostrarAyuda()
{
 ...
 *
 * Esta función imprime en consola la descripción y el uso del comando especificado.
 *
 * Ejemplo:
 * mostrarAyudaComando("cargar"); // Muestra la ayuda para el comando 'cargar'.
 */
void mostrarAyudaComando(const string &comando)
{
    ...
    {
        cout << "\nUso: v_cercanos_caja nombre_objeto\n"
    ...
    else if (comando == "ruta_corta")
    {
        cout << "\nUso: ruta_corta i1 i2 nombre_objeto\n"
             << "    Identifica los índices de los vértices que conforman la ruta más corta entre los vértices dados para el objeto nombre_objeto.\n\n";
    }
    else if (comando == "ruta_corta_centro")
    {
        cout << "\nUso: ruta_corta_centro i1 nombre_objeto\n"
             << "    Identifica los índices de los vértices que conforman la ruta más corta entre el vértice dado y el centro del objeto nombre_objeto.\n\n";
    }
...
int main()
{
    ...
    while (true)
    {
        ...
        case Comando::RUTA_CORTA:
        {
            ss >> x >> y >> nombreObjeto;

            s.rutaCorta(stoi(x), stoi(y), nombreObjeto);

            break;
        }
        case Comando::RUTA_CORTA_CENTRO:
        {
            ss >> parametro >> nombreObjeto;

            s.rutaCortaCentro(stoi(parametro), nombreObjeto);
